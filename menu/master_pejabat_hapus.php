...
echo"<div class='box box-solid box-danger'>
                                ...
                                <div class='box-body'>";
$data	= mysql_query ("SELECT * from tblpejabat where id_pejabat='$_GET[id]'");
$dt	= mysql_fetch_array ($data);
$aktifitas="User $_SESSION[username] Melakukan Penghapusan Data JAbatan $dt[nama_pejabat] $dt[jabatan]";
				include"key_log.php";
				
$delete=mysql_query("delete from tblpejabat where id_pejabat='$_GET[id]'") or die (mysql_error());
if($delete){				
$hal="?mn=master_pejabat";
	echo"<br/><p align=center><img title='image/ajax-loader-7.gif' src='image/ajax-loader-7.gif'>
	<br/><b>Data Pejabat Berhasil Dihapus</b></p>";
