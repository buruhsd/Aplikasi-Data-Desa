...
echo"<form method='POST' action='media.php?mn=data_permohonan_kk_lagi_simpan'>";
echo"<input type=hidden name='kk' value='$_POST[kk]' class='form-control' required >";
...
echo"<tr><td>Alamat</td><td><div class='col-md-10'><input type='text' name='alamat' id='alamat' class='form-control'></td></tr>";
echo"<tr>
        <td>Akta Lahir</td>
