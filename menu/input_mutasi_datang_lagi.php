...
<?php
$id = $_POST['kk'];
$data 	= mysql_query ("SELECT * from tblpenduduk where NoKK = '$id'");
...
echo"<tr><td colspan='2' bgcolor='#99CCFF'><center>Jenis Mutasi Datang</center><input type=hidden name='status' value='mutasi datang' class='form-control'></td></tr>
		<tr>
	...
	echo"<tr>
				...
				<tr>
					...
					<td><div class='col-md-5'><input type='text' name='xNoKKLama' value='$dt[xNoKKLama]' class='form-control' readonly/></td>
				</tr>
				<tr>
...
echo"</div></select></td></tr>";
echo"<tr><td>No Kartu Keluarga</td><td><div class='col-md-8'><input type=text value='$dt[NoKK]' name='NoKK' class='form-control' required readonly></div></td></tr>";
echo"<tr>
		<td>Jalan</td>
