...
$master_pekerjaaan = mysql_query("SELECT * from tblpekerjaan where PekerjaanID ='$id'");
$mpk=mysql_fetch_array($master_pekerjaaan);

echo"<form method='POST' action='media.php?mn=master_pekerjaan_update'>";
echo"<table class='table'>
		<tr><td>ID Pendidikan</td><td><div class='col-md-2'><input type='text' name='id' value='$id' readonly class='form-control'></div></td></tr>
		<tr><td>Nama Pendidikan</td><td><div class='col-md-5'><input type='text' name='nama_pekerjaan' value=".strtoupper($mpk['NamaPekerjaan'])." required class='form-control'></div></td></tr>";
