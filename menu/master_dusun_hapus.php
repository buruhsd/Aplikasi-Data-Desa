...
$data	= mysql_query ("SELECT * from tbldusun where DusunID='$_GET[id]'");
$dt	= mysql_fetch_array ($data);

$aktifitas="User $_SESSION[username] Melakukan Penghapusan Data Dusun $dt[NamaDusun]";
				include"key_log.php";
				
$delete=mysql_query("delete from tbldusun where DusunID='$_GET[id]'") or die (mysql_error());
if($delete){				
$hal="?mn=master_dusun";
	echo"<br/><p align=center><img title='image/ajax-loader-7.gif' src='image/ajax-loader-7.gif'>
	<br/><b>Data Dusun Berhasil Dihapus</b></p>";
