...
$data	= mysql_query ("SELECT * from tblpekerjaan where PekerjaanID='$_GET[id]'");
$dt	= mysql_fetch_array ($data);

$aktifitas="User $_SESSION[username] Melakukan Penghapusan Data Pekerjaan $dt[NamaPekerjaan]";
				include"key_log.php";
				
$delete=mysql_query("delete from tblpekerjaan where PekerjaanID='$_GET[id]'") or die (mysql_error());
if($delete){				
$hal="?mn=master_pekerjaan";
	echo"<br/><p align=center><img title='image/ajax-loader-7.gif' src='image/ajax-loader-7.gif'>
	<br/><b>Data Pekerjaaan Berhasil Dihapus</b></p>";
