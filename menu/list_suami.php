...
// namalenkpa, nomorkk, nik, alamat, rt, rw, kodepos
	function pilih(nama,nik,tempatlahir,tgl,umur){
		self.opener.document.forms[0].NoIdentitasCalonSuami.value=nik;
		self.opener.document.forms[0].NamaCalonSuami.value=nama; 
		self.opener.document.forms[0].TempatLahirCalonSuami.value=tempatlahir;
		self.opener.document.forms[0].TanggalLahirCalonSuami.value=tgl;
		self.opener.document.forms[0].UmurCalonSuami.value=umur;
		window.close();
	}
