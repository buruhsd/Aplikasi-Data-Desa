...
// namalenkpa, nomorkk, nik, alamat, rt, rw, kodepos
	function pilih(nama,nik,tgl,umur,pekerjaan,alamat,kelurahan){
		self.opener.document.forms[0].NamaIbu.value=nama;
		self.opener.document.forms[0].NikIbu.value=nik;
		self.opener.document.forms[0].TglIbu.value=tgl;
		self.opener.document.forms[0].UmurIbu.value=umur;
		self.opener.document.forms[0].PekerjaanIbu.value=pekerjaan;
		self.opener.document.forms[0].AlamatIbu.value=alamat;
		self.opener.document.forms[0].KelurahanIbu.value=kelurahan;
		window.close();
	}
...
<div class="box-body table-responsive">
  ...
  $sql = "select * from tblpenduduk where JenisKelamin='1' ORDER BY TanggalLahir DESC"; 
