...
// namalenkpa, nomorkk, nik, alamat, rt, rw, kodepos
	function pilih(nama,nokk){
		self.opener.document.forms[0].NamaKK.value=nama;
...
<div class="box-body table-responsive">
  ...
  $sql = "select * from tblpenduduk where PosisiKKID='0' ORDER BY TanggalLahir DESC"; 
...
?>
	<tr><td><?php echo"$no";?></td>
			...
			<td><a href="#" onClick="javascript:pilih('<?php echo"$nama";?>',
														'<?php echo"$nokk";?>')"><?php echo"$nik";?></a></td>
			<td><?php echo"$nama";?></td>
			<td><?php echo"$umur";?></td>
