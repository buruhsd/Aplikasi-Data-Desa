...
echo"<div class='box box-solid box-danger'>
                                ...
                                <div class='box-body'>";
$data	= mysql_query ("SELECT * from tblagama where AgamaID='$_GET[id]'");
$dt	= mysql_fetch_array ($data);
$aktifitas="User $_SESSION[username] Melakukan Penghapusan Data Agama $dt[NamaAgama]";
				include"key_log.php";
				
$delete=mysql_query("delete from tblagama where AgamaID='$_GET[id]'") or die (mysql_error());
if($delete){				
$hal="?mn=master_agama";
	echo"<br/><p align=center><img title='image/ajax-loader-7.gif' src='image/ajax-loader-7.gif'>
	<br/><b>Data Agama Berhasil Dihapus</b></p>";
